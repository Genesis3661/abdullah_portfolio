...
export const projects: Project[] = [
  ...
  // --------------------------- Other major ----------------------------
  {
    ...
    overview:
      "A workflow automation platform and product for enterprise clients. Developer teams build apps on top of it using fully dynamic Angular forms, approval chains, and automated calculations that replace manual, error prone processes with auditable, real time workflows.",
    highlights: [
      "Built the Promotional Expenses Management application on Rapidflow, enabling clients to define yearly budgets, raise expense requests, obtain approvals from the required approvers, and formally close requests once completed.",
      "Built Application Delivery Management application, streamlining employee onboarding and offboarding via configurable checklists assigned across organizational sections.",
